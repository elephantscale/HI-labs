...
$ hadoop jar a.jar   hi.hdfs.HdfsClientWrite   ../data/hdfs-data/sample.txt   <user-name>/hdfs-data/out/sample-out.txt
...
run
$ hadoop jar a.jar   hi.hdfs.HdfsClientRead   <user-name>/hdfs-data/out/sample-out.txt
