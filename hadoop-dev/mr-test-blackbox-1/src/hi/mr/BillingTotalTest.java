...
public class BillingTotalTest extends Configured implements Tool
{
    public static void main(String[] args) throws Exception
    {
        int res = ToolRunner.run(new Configuration(), new BillingTotalTest(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception
    {
        ...
        Job job = new Job(conf, getClass().getName() + "--<your name>"); // TODO : your name
        job.setJarByClass(BillingTotalTest.class);
        job.setMapperClass(MyMapper.class);
        job.setReducerClass(MyReducer.class);
        //job.setNumReduceTasks(?);  // TODO : set number of reducers to 1
