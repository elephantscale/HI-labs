...
export additional_classpath=/usr/hdp/$HADOOP_VERSION/hive/lib/*:/usr/hdp/$HADOOP_VERSION/pig/*:/usr/hdp/$HADOOP_VERSION/pig/lib/*:./lib/*:/opt/cloudera/parcels/CDH/jars/*:/usr/lib/pig/*:/usr/lib/pig/lib/*:/usr/lib/hive/lib/*
