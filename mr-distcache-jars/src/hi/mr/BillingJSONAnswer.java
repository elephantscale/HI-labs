...
public class BillingJSONAnswer extends Configured implements Tool
{
    public static void main(String[] args) throws Exception
    {
        int res = ToolRunner.run(new Configuration(), new BillingJSONAnswer(), args);
        System.exit(res);
    }
...
//            System.out.println (record);
            try
            {
                ...
                String customerIdStr = jsonMap.get("customer_id");
                String costStr = jsonMap.get("cost");
